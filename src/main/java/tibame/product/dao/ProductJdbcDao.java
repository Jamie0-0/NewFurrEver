...
public class ProductJdbcDao {
	...
	public List<Product> findMyProductByUid(Integer uid) {
		...
		List<Product> trips = namedParameterJdbcTemplate.query(sql, paramMap, new BeanPropertyRowMapper<>(Product.class));
		return trips;
	}
